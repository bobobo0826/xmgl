...
import com.qgbest.xmgl.employee.client.DictionaryFeignClient;
...
@Controller
@RequestMapping(value = "/manage/dictionaryEmp")
public class EmpDicController extends BaseController {
  //  public static final Logger lgger = LoggerFactory.getLogger(ProjectController.class);
     ...
     * @return
     */
    @RequestMapping(value = "/initEmpDictionaryList")
    public ModelAndView initEmpDictionaryList() {
        ...
        return new ModelAndView("/dictionary/employee/empDicList", model);
    }
    /**
     * 初始化项目选择页面
     * @return
...
//        return new ModelAndView("/dictionary/dicInfo",model);
        Map model = new HashMap();
        model.put("id",id);
        return new ModelAndView("/dictionary/employee/empDicInfo",model);

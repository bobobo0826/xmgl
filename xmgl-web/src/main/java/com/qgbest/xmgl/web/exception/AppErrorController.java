package com.qgbest.xmgl.web.exception;
...
public class AppErrorController implements ErrorController {
    ...
    public ModelAndView errorHtml(HttpServletRequest request) {
        ...
        if (status == 404){
            mav = new ModelAndView("../../common/404", map);
        } else if (status == 403){
            mav = new ModelAndView("../../common/403", map);
        } else if (status == 500){
            mav = new ModelAndView("../../common/500", map);
        } else {
            mav = new ModelAndView("../../common/welcome", map);
        }

...
ShowPointLocalContorlName:"drawPosition"
...
$("#"+me._opts.ShowPointLocalContorlName+"").val(northWestPoint.lng+","+northWestPoint.lat+","+southEastPoint.lng + "," + southEastPoint.lat);
// 停止事件冒泡传播和默认事件
stopBubble(e);
return preventDefault(e);

 ...
 */
 ...
 "background:#fff url(<%=request.getContextPath()%>/res/public/js/jquery.easyui/themes/default/images/pagination_loading.gif) no-repeat scroll 5px 10px;border:2px solid #ccc;color:#000;'>正在加载，请等待...</div></div>";

...
var _1d="<div class=\"messager-icon messager-question\"></div>"+"<div>"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><textarea style=\"width:250px;height:50px;\" class=\"messager-input\" ></textarea></div>";
var _1e={};

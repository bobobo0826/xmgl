  ...
  <script type="text/javascript">
    ...
    function setUpload(){
      $("#filename").uploadifive({
        'uploadScript' : '${root}/manage/project/uploadResponseFile',//请求响应的Action
    ...
    function uploadAll(){
      $('#filename').data('uploadifive').settings.formData = {'id':$('#id').val()};   //动态更改formData的值

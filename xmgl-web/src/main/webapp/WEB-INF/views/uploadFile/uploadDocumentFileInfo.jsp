  ...
  <script type="text/javascript">
    ...
    function setUpload(){
      $("#filename").uploadifive({
        'uploadScript' : '${root}/manage/project/uploadFile',//请求响应的Action
    ...
    function uploadAll(){
      $('#filename').data('uploadifive').settings.formData = {'id':$('#id').val(),'price':$("#price").val(),'projectId':$("#projectId").val()};   //动态更改formData的值
      ...
      <div class="ibox">
        <div class="ibox-content">
          <div class="col-sm-12">
            ...
            <label class="col-sm-1 control-label" style="margin-top:5px;">费用：</label>
            <div class="col-sm-4" >

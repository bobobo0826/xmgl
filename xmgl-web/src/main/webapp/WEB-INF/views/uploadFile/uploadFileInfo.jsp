  ...
  <script type="text/javascript">
    ...
    function setUpload(){
      $("#filename").uploadifive({
        'uploadScript' : '${root}/manage/pretrial/saveUploadAfterCallInfo',//请求响应的Action
    ...
    function uploadAll(){
      $('#filename').data('uploadifive').settings.formData = {'_id':$('#id').val(),'_moudle':$('#_moudle').val()};   //动态更改formData的值
      $('#filename').uploadifive('upload');
      //parent.$('#attstt').datagrid('load');
      // f_close('newWindow');
    }
  </script>
</head>

...
<head>
    ...
    <script type="text/javascript">
        ...
        function initStaffTaskList(height) {
            var url = "${root}/manage/project/getGridStyle?_curModuleCode=" + $("#_curModuleCode").val();
        ...
        function oprHandle(itemId, rowData, rowIndex) {
            switch (itemId) {
                case "saveGridStyle":
                    saveGridStyle("tt", "${root}/manage/project/saveGridStyle?_curModuleCode=" + $("#_curModuleCode").val());
                    break;
                case "showColumns":
                    var url = "${root}/manage/project/showGridColumn";
        ...
        function getUrl() {
            var url = "${root}/manage/operateProjectLog/getProjectOperateLog/" + getQueryCondition();

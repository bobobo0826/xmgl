...
<head>
    ...
    <script type="text/javascript">
        var myform = angular.module('mybody', ['ui.bootstrap']).controller('bodyCtrl', function($scope, $compile, $http) {
            $scope.model = {};
            var url = '${root}/manage/dictionaryFile/getDictionaryInfoById/'+ $("#id").val();
            ...
            $scope.processForm = function(funcCode) {
                ...
                layer.confirm('确定'+msg+'吗?', {
                    ...
                    /**
                     * $('#testSelect option:selected').text();//选中的文本，解决编码与文本之间的转换
                     * @type {*}
                     */
                    ...
                    var url="${root}/manage/dictionaryFile/saveDictionary/";

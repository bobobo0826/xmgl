...
<head>
    ...
    <script type="text/javascript">
        ...
        function getUrl() {
            var url="${root}/manage/dictionaryEmp/queryDictionaryList"+getQueryCondition();
        ...
        function editInfo(index){
            ...
            var width="85%";
            var height="60%";
            var url="${root}/manage/dictionaryEmp/initDictionaryInfo/"+id;
            parent.addTab("员工字典详情",url);
        ...
        function enabled(index) {
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionaryEmp/startDictionaryById/"+id;
        ...
        function forbidden(index) {
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionaryEmp/forbiddenDictionaryById/"+id;
        ...
        function deleteInfo(index){
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionaryEmp/delDictionaryInfoById/"+id;
        ...
        function doAdd() {
            var width="85%";
            var height="60%";
            var url="${root}/manage/dictionaryEmp/initDictionaryInfo/"+0;
            parent.addTab("新增员工字典",url);
        }
        /**
         * 获取业务类型列表
         */
        ...
        function getBusinessTypeList(){
            var url = "${root}/manage/dictionaryEmp/getBusinessTypeList";
            url=encodeURI(encodeURI(url));
            $.ajax({
                url:url,
                type:'get',

...
<head>
    ...
    <script type="text/javascript">
        ...
        function getUrl() {
            var url="${root}/manage/dictionary/queryDictionaryList"+getQueryCondition();
        ...
        function editInfo(index){
            ...
            var width="85%";
            var height="60%";
            var url="${root}/manage/dictionary/initDictionaryInfo/"+id;
            parent.addTab("项目字典详情",url);
        ...
        * */
        function enabled(index) {
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionary/startDictionaryById/"+id;
        ...
        function forbidden(index) {
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionary/forbiddenDictionaryById/"+id;
        ...
        function deleteInfo(index){
            var rows=$('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/dictionary/delDictionaryInfoById/"+id;
        ...
        function doAdd() {
            var width="85%";
            var height="60%";
            var url="${root}/manage/dictionary/initDictionaryInfo/"+0;
            parent.addTab("新增项目字典",url);
        }
        /**
         * 获取业务类型列表
         */

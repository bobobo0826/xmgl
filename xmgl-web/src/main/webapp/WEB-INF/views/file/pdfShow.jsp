...
<head>
    ...
    <link rel="stylesheet" href="/res/pdf/web/viewer.css">
    <script src="/res/pdf/web/compatibility.js"></script>
    <link rel="resource" type="application/l10n" href="/res/pdf/web/locale/locale.properties">
    <script src="/res/pdf/web/l10n.js"></script>
    <script src="/res/pdf/buildpdf/pdf.js"></script>
    <script src="/res/pdf/web/viewer.js"></script>
    <script type="application/javascript">
        $(document).ready(function(){
            DEFAULT_URL = encodeURI(encodeURI("${root}/manage/file/convertFileIo?path="+$("#filePath").val()));
        });
    </script>
</head>
<body>
    ...
    <div id="sidebarContainer">
        <div id="toolbarSidebar">
            <div class="splitToolbarButton toggled">
                ...
                <button id="viewOutline" class="toolbarButton group" title="Show Document Outline (double-click to expand/collapse all items)"

...
<head>
    ...
    <script type="text/javascript">
        ...
        function createRichText() {
            ...
            kindEditer1 = createY(eObj0.id);
            kindEditer2 = createY(eObj1.id);
        ...
        function getDic() {
            var url = "${root}/manage/monthLog/getMonthLogTaskTypeDic";
            url = encodeURI(encodeURI(url));
            $.ajax({
                url: url,
                type: 'post',
        ...
        function selectModule() {
            ...
            var windowName = "moduleWindow";
            var windowTitle = "选择模块";
            var width = "20%";
            var height = "80%";
...
<input type="hidden" id="task_condition" value="${task_condition}"/>
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-sm-4">
                        <div class=" form-group">
                            ...
                            <div class="col-sm-6" data-autoclose="true">
                    ...
                    <div class="col-sm-4" id="plan_name_head">
                        <div class=" form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="plan_name" name="plan_name" readonly required="true"/>
                            </div>
                            <div class="col-sm-2">
                                <span class="text-danger">*</span>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" id="record_div">
                                <textarea type="text" class="richtext" id="record" name="richtext" rows="6" required="true"></textarea>
                            </div>
                            <div class="col-sm-1">
                                <span class="text-danger">*</span>
                            </div>
...
<div class="main_btnarea">
    <div class="btn_area_setc btn_area_bg" id="operator">
        <a id='qd' style="display:none" class='btn btn-primary btn-sm' href='###' onclick='confirm()'><i class='fa fa-check'></i>&nbsp;&nbsp;确定</a>

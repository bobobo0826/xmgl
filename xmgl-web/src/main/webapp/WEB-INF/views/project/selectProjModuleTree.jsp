...
<input type="hidden" id="moduleListStr"  value="${moduleListStr}" />
<div>
...
<script type="text/javascript">
    ...
    var dTree = {
        ...
        init:function(id,option)
        {
            ...
            var _this = this;
            //设置data
            var moduleListStr=$("#moduleListStr").val();
            this.data = JSON.parse(moduleListStr.replace(/'/g, '"'));
            this.setting = {
                view: {
                    showIcon: false,
                    showLine: true,
                ...
                check:option.check || {
                    ...
                    chkboxType:option.chkboxType || { "Y": "ps", "N": "ps" },
        ...
        need:function(node)
        {
            ...
            if(this.needModel)
            {
                ...
                res.id = node.mid;
                res.moduleCode = node.id;
                res.moduleName = node.name;
    ...
    {
        parent.setModule(dTree.resVal);
        f_close("moduleWindow");
    }
    function openTree()
    {

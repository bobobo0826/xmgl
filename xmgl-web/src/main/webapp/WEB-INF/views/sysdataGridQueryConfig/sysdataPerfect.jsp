...
<head>
    ...
    <script type="text/javascript">
        ...
        var myform = angular.module('mybody', ['ui.bootstrap']).controller('bodyCtrl', function ($scope, $compile, $http) {
            ...
            $scope.model = {};
            var url = '${root}/manage/SysdataGridQuery/getSysdataInfo/' + $("#id").val();
            ...
            $scope.processForm = function (funcCode) {
                if (checkInputValueIsEmpty()) {
                   ...
                   /* $scope.model.sysdataBase.base_json=JSON.parse($("#base_json").val());*/
                    layer.confirm('确定保存吗?', {
                            btn: ['确定', '取消'], //按钮
                            shade: false //不显示遮罩
                        }, function (index) {
                            var url = "${root}/manage/SysdataGridQuery/saveSysdata";
                            $http({
                                method: 'POST',
                ...
                <div class="ibox-content">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea ng-model="model.sysdataBase.base_json" type="text" class="form-control"
                                       rows="10"   id="base_json" name="base_json"  required="true"></textarea>
                            </div>
                            <span class="text-danger">*</span>
                        </div>
                    </div>
                ...
                <div class="ibox-content">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input ng-model="model.sysdataBase.create_date" class="form-control"
                                       id="create_date" name="create_date"  required="true" readonly/>

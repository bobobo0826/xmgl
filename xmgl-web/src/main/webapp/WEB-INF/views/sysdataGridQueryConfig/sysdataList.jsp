...
/*                     html += "<a class='btn btn-success btn-sm' href='javascript:a();' id='dc'><i class='fa fa-plus'></i>&nbsp;&nbsp;11</a>&nbsp;&nbsp;";*/
        ...
        function initBCOfferDetail(height){
            $("#tt").datagrid({
                ...
                columns:[[
                    ...
                    {field:"base_json",title:"业务数据", resizable:true,width:120,headalign:"center",align:"left",sortable:true},
        ...
        function getUrl() {
            var url="${root}/manage/SysdataGridQuery/getSysdataGridQueryConfig/"+getQueryCondition();
       ...
       function getQueryCondition() {
        ...
        function editInfo(index) {
            ...
            var url = "${root}/manage/SysdataGridQuery/intoSysdataPerfect/" + id;
            parent.addTab("系统参数配置详情", url);
        }
      /*  function  a(){
            var url="${root}/manage/SysdataGridQuery/intoceshi/" + "DDGL";
            parent.addTab("测试", url);
        }*/
        function deleteInfo(index) {
            var rows = $('#tt').datagrid('getData').rows;
            var id = rows[index].id;
            var url = "${root}/manage/SysdataGridQuery/delSysdataQueryById/" + id;
        ...
        function addSysdata() {
            var url = "${root}/manage/SysdataGridQuery/intoSysdataPerfect/" + "0";

  ...
  <script type="text/javascript">
    ...
    function setUpload(){
      $("#filename").uploadifive({
        'uploadScript' : '${root}/manage/file/uploadFileInfo',//请求响应的Action
...
/*        'buttonImg'    : '${root}/thirdparty/uploadify/img/selectFile.jpg',*/
        ...
        {
          var data = eval("(" + data + ")");
          parent.setPhoto(data.fileInfoList[0].filePath+"\\"+data.fileInfoList[0].fileId);
          msg = data.msg;
          if(data.success)
          {
            //parent.initAttsDataGrid();
    ...
    function uploadAll(){
      $('#filename').data('uploadifive').settings.formData = {'_id':$('#id').val(),'_module':$('#_module').val()};   //动态更改formData的值
...
<form name="myform" method="post"  onsubmit="return false;">
  ...
  <input type="hidden" id="_module" name="_module" value="${_module}">
  <div class="row">
    <div class="col-sm-12">
      <div class="ibox">
        <div class="ibox-content">
          ...
          <div class="col-sm-12">
            <label>待上传文件列表</label>
            <fieldset style="height:210px; overflow-y:auto;border:1px solid #bbb">

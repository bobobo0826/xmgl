 ...
 */
    ...
    public void testQueryDictionaryList()throws Exception{
        ...
        queryMap.put("business_name","就职状态");
    ...
    public void testGetBusinessTypeList()throws Exception{
      ...
      mockMvc.perform(requestBuilder)
              .andExpect(status().isOk())
              .andExpect(content().string(containsString("就职状态")))
              .andDo(print());
    }
    /**
     * 测试根据id获取字典详情
    ...
    public void testGetDictionaryInfoById()throws Exception{
        RequestBuilder requestBuilder = post(DictionaryServiceHTTPConstants.RequestMapping_getDictionaryInfoById,1).accept(MediaType.APPLICATION_JSON_UTF8);
        mockMvc.perform(requestBuilder)
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("就职状态")))
                .andDo(print())
                .andExpect(jsonPath("$.business_name").value("就职状态"));
    ...
    public void testSaveDictionary()throws Exception{
        ...
        dictionary.setBusiness_name("学历背景");
        dictionary.setBusiness_type("education_bg");
        dictionary.setData_code("QT");
        dictionary.setData_desc("其他");
        dictionary.setData_name("其他");
        dictionary.setIs_used(1);
        ...
        mockMvc.perform(requestBuilder)
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("学历背景")))
                .andDo(print())
                .andExpect(content().string(containsString("操作成功")));

...
import com.qgbest.xmgl.employee.api.entity.FormOperate;
import com.qgbest.xmgl.employee.api.entity.FormOperateType;
import com.qgbest.xmgl.employee.api.entity.FormType;
import com.qgbest.xmgl.employee.service.dao.FormOperateRepository;
import com.qgbest.xmgl.employee.service.dao.FormOperateTypeRepository;
import com.qgbest.xmgl.employee.service.dao.LogRepository;
import com.qgbest.xmgl.employee.service.dao.LogRepositoryExtend;
...
//					newValue = getDateNameById(newValue, fromTypeId, propertyName, "");
                    if (!"jsonb".equals(fieldType)) {
                        ...
                        String oldStr = String
                                .valueOf((JsonUtil.fromJsonToMap(oldObject)).get(propertyName));
                        if (newStr!=null&&!newStr.equals("") && oldStr!=null&&!oldStr.equals("")) {

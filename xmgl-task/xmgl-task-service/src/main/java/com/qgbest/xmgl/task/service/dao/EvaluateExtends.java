...
public class EvaluateExtends {
    ...
    public PageControl getEvaluationList(Map queryMap, int cpage, int len, TcUser user) {
        String count = "";
        String sql="SELECT ID,task_id,task_name,evaluate_object_code,single_contractor,evaluate_type_code," +
    ...
    public PageControl getEvaluationListByTaskId(Map queryMap, int cpage, int len, TcUser user,int task_id) {
        String count = "";
        String sql="SELECT ID,task_id,task_name,evaluate_object_code,single_contractor,evaluate_type_code," +
                "evaluate_sup_type_code,evaluate_level_code,evaluate_description,evaluate_people,evaluate_time," +
                "b.data_name AS evaluate_object,C .data_name AS evaluate_type,d.data_name AS evaluate_sup_type," +
                ...
                "LEFT JOIN (SELECT data_name,data_code FROM d_common_dic WHERE business_type = 'evaluate_sup_type_code') d ON A .evaluate_sup_type_code = d.data_code " +
                "LEFT JOIN (SELECT data_name,data_code FROM d_common_dic WHERE business_type = 'evaluate_level_code') e ON A .evaluate_level_code = e.data_code " +
                "WHERE task_id ='"+task_id+"' and evaluate_object_code='TASK'";
        if (StringUtils.isNotBlankOrNull(queryMap.get("evaluate_level"))) {
            sql += " AND evaluate_level_code = '" + queryMap.get("evaluate_level") + "'";
        }
        if (StringUtils.isNotBlankOrNull(queryMap.get("evaluate_type"))) {
    ...
    public PageControl getEvaluationListByEmployeeId(Map queryMap, int cpage, int len, TcUser user,String single_contractor,int task_id) {
        String count = "";
        String sql="SELECT ID,task_id,task_name,evaluate_object_code,single_contractor,evaluate_type_code," +
                "evaluate_sup_type_code,evaluate_level_code,evaluate_description,evaluate_people,evaluate_time," +
                "b.data_name AS evaluate_object,C .data_name AS evaluate_type,d.data_name AS evaluate_sup_type," +
                ...
                "LEFT JOIN (SELECT data_name,data_code FROM d_common_dic WHERE business_type = 'evaluate_sup_type_code') d ON A .evaluate_sup_type_code = d.data_code " +
                "LEFT JOIN (SELECT data_name,data_code FROM d_common_dic WHERE business_type = 'evaluate_level_code') e ON A .evaluate_level_code = e.data_code " +
                "WHERE single_contractor ='"+single_contractor+"' and task_id='"+task_id+"' and evaluate_object_code='PEOPLE'";
        if (StringUtils.isNotBlankOrNull(queryMap.get("evaluate_level"))) {
            sql += " AND evaluate_level_code = '" + queryMap.get("evaluate_level") + "'";
        }
        if (StringUtils.isNotBlankOrNull(queryMap.get("evaluate_type"))) {
    ...
    public List getEvaluationByTaskId(int task_id){
        String sql="SELECT ID,task_id,task_name,evaluate_object_code,single_contractor,evaluate_type_code,evaluate_sup_type_code,evaluate_level_code,evaluate_description,evaluate_people,evaluate_time,modify_time FROM evaluation WHERE task_id ='"+task_id+"' AND evaluate_object_code = 'TASK'";
        List list=commonDao.getSql(sql);
        return list;

    }

    public List getEvaluationByEmpIdAndEvaType(int task_id,String single_contractor,String evaluate_type_code){
        String sql="SELECT ID,task_id,task_name,evaluate_object_code,single_contractor,evaluate_type_code,evaluate_sup_type_code,evaluate_level_code,evaluate_description,evaluate_people,evaluate_time,modify_time FROM evaluation WHERE task_id ='"+task_id+"' and single_contractor ='"+single_contractor+"' and  evaluate_type_code='"+evaluate_type_code+"' AND evaluate_object_code= 'PEOPLE'";
        List list=commonDao.getSql(sql);
        return list;

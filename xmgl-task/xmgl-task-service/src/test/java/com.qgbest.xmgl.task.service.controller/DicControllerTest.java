...
import com.qgbest.xmgl.task.api.constants.CommonDicServiceHTTPConstants;
...
public class DicControllerTest {
    ...
    public void testGetDicListByBusinessCode() throws Exception {
        String businessCode = "report_cycle";
    ...
    public void testGetDataNameByDataCode() throws Exception {
        String businessCode = "report_cycle";
        String dataCode = "WEEK";
        RequestBuilder request = get(CommonDicServiceHTTPConstants.RequestMapping_getDataNameByDataCode,businessCode,dataCode);
